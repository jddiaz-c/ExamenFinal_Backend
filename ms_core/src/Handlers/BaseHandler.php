...
abstract class BaseHandler
{
    ...
    function create(Request $req, Response $resp): Response
    {
        try {
    ...
    {
        try {
            return $this->json($resp, $this->getController()->getOne($args['id']));
        } catch (Exception $e) {
            return $this->handleError($resp, $e);
        }
    }
    ...
    function delete(Request $req, Response $resp, array $args): Response
    {
        try {
            ...
            return $this->json($resp, ['message' => 'Eliminado correctamente.']);
        } catch (Exception $e) {
            return $this->handleError($resp, $e);
        }
    }
